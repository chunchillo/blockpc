<?php
/* Clase noactivosModelo */
namespace Usuarios\Index\Modelo;

use Blockpc\Clases\Modelo;

final class noactivosModelo extends Modelo {
    ...
    {
        $where = " AND u.activado = 0 AND u.deleted_at IS NULL ";
        if ( $idUsuario > 1 ) {
            $where = " AND u.role > 1 AND u.activado = 0 AND u.deleted_at IS NULL ";
        }
