...
final class noactivosControlador extends Controlador
{
    ...
    public function __construct() {
        $this->construir();
        $this->_modelo = $this->cargarModelo('noactivos');
    ...
    public function index(int $pagina = 0): void
    {
        try {
            ...
            $this->_vista->asignar('titulo', 'Usuarios No Activos');
	...
	private function usuarios(int $pagina, int $limite = 25, string $orden = 'ASC', string $campo = 'u.id', string $search = '')
	{
		...
		$tabla = $this->cargarLibreria('TablaBlockpc', 'Usuarios No Activos', 8);
